<?php
/**
 * Página Local SEO - Murcia Capital
 * Contenido único - Centro neurálgico regional
 */

$page_title = "Empresa de Seguridad en Murcia Capital | Vigilantes y Alarmas";
$page_description = "Servicios de seguridad privada en Murcia capital. Vigilantes, control de accesos, consultoría. Experiencia en el sector desde hace años.";
$page_keywords = "seguridad Murcia, vigilantes Murcia, empresa seguridad Murcia";
$current_page = 'local-seguridad-murcia';
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                <div class="inline-flex items-center px-4 py-2 bg-praxis-gold/10 border border-praxis-gold/30 rounded-full mb-6">
                    ...
                    <span class="text-praxis-gold font-semibold">Cobertura en Murcia Capital</span>
                </div>
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-praxis-white mb-6 leading-tight">
                    ...
                    <span class="text-praxis-gold">Murcia Capital</span>
                </h1>
                
                <p class="text-xl text-praxis-gray-light mb-8 leading-relaxed">
                    Murcia capital, como centro neurálgico de la región, concentra empresas de servicios, comercios y administraciones públicas que requieren seguridad profesional.
                    Tiempo de respuesta: <span class="text-praxis-gold font-semibold">25 minutos</span>.
                </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-praxis-black/50 border border-praxis-gold/20 rounded-xl p-6">
                ...
                <ul class="space-y-2">
                    <li class="text-praxis-gray-light"><i class="fas fa-check text-praxis-gold mr-2"></i>Polígono Oeste</li>
                    <li class="text-praxis-gray-light"><i class="fas fa-check text-praxis-gold mr-2"></i>Espinardo Científico</li>
                    <li class="text-praxis-gray-light"><i class="fas fa-check text-praxis-gold mr-2"></i>La Estrella</li>
                </ul>
            </div>
            ...
            <div class="bg-praxis-black/50 border border-praxis-gold/20 rounded-xl p-6">
                ...
                <ul class="space-y-2">
                    <li class="text-praxis-gray-light"><i class="fas fa-check text-praxis-gold mr-2"></i>Centro</li>
                    <li class="text-praxis-gray-light"><i class="fas fa-check text-praxis-gold mr-2"></i>El Carmen</li>
                    <li class="text-praxis-gray-light"><i class="fas fa-check text-praxis-gold mr-2"></i>La Flota</li>
                    <li class="text-praxis-gray-light"><i class="fas fa-check text-praxis-gold mr-2"></i>Vistabella</li>
                </ul>
            </div>
            ...
            <div class="bg-praxis-black/50 border border-praxis-gold/20 rounded-xl p-6">
                ...
                <ul class="space-y-2">
                    <li class="text-praxis-gray-light"><i class="fas fa-check text-praxis-gold mr-2"></i>Administración</li>
                    <li class="text-praxis-gray-light"><i class="fas fa-check text-praxis-gold mr-2"></i>Comercio</li>
                    <li class="text-praxis-gray-light"><i class="fas fa-check text-praxis-gold mr-2"></i>Servicios</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-gradient-to-br from-praxis-gray-dark to-praxis-black p-8 rounded-2xl border-2 border-praxis-gold/20 hover:border-praxis-gold transition-all">
                ...
                <p class="text-praxis-gray-light">Análisis de riesgos y consultoría estratégica para empresas y administraciones.</p>
            </div>
            ...
            <div class="bg-gradient-to-br from-praxis-gray-dark to-praxis-black p-8 rounded-2xl border-2 border-praxis-gold/20 hover:border-praxis-gold transition-all">
                ...
                <h3 class="text-xl font-semibold text-praxis-white mb-3">Vigilantes Físicos</h3>
                <p class="text-praxis-gray-light">Personal de seguridad cualificado para comercios, eventos y edificios.</p>
            </div>
            
            <div class="bg-gradient-to-br from-praxis-gray-dark to-praxis-black p-8 rounded-2xl border-2 border-praxis-gold/20 hover:border-praxis-gold transition-all">
                <div class="w-16 h-16 bg-praxis-gold/10 rounded-xl flex items-center justify-center mb-6">
                    <i class="fas fa-desktop text-praxis-gold text-3xl"></i>
                </div>
                <h3 class="text-xl font-semibold text-praxis-white mb-3">Sistemas Integrados</h3>
                <p class="text-praxis-gray-light">Plataformas de seguridad completas con CCTV, control de accesos y alarmas.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-heading font-bold text-praxis-white mb-4">
                Solicita tu Presupuesto en Murcia
            </h2>
        ...
        <div class="bg-praxis-black/50 border-2 border-praxis-gold/20 rounded-2xl p-8">
            <form action="/api/contact.php" method="POST" class="space-y-6">
                <input type="hidden" name="ciudad" value="Murcia">
...
<section class="py-12 bg-praxis-gold">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap items-center justify-between gap-6">
            <div>
                <h3 class="text-2xl font-heading font-bold text-praxis-black mb-2">Praxis Seguridad - Murcia</h3>
